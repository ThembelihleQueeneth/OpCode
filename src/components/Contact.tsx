        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-5">
            ...
            <a
              ...
              className="flex gap-4 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
            >
              <span className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#5465FF]/10">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="mt-1 block text-gray-600 hover:text-[#5465FF]"
                  >
                    +27 79 331 6193
                  </a>
            ...
            <a
              ...
              className="flex gap-4 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
            >
              <span className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-green-100">
            ...
            {/* Location */}
            <div className="flex gap-4 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
              <span className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-[#5465FF]/10">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-lg">
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full rounded-xl bg-[#5465FF] py-4 font-semibold text-white shadow-lg shadow-[#5465FF]/20 transition hover:bg-[#4354F5] hover:shadow-xl"
              >
                Send Message
              </button>
